...
import { changePassword } from '@/redux/features/User/userActions';
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center w-screen h-screen bg-main">
        ...
        <NotAuthorized message="No token" height={250} open={isNotAuthorized} onClose={() => setIsNotAuthorized(false)} />
      </div>
    </>
  )
}
